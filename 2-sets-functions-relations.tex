...
\begin{figure}[ht!]
    ...
    \label{fig:injective-surective-examples}
\end{figure}

\begin{examples}[Injective and Surjective Functions]
    We refer to \autoref{fig:injective-surective-examples}.
...
Figure \autoref{fig:quotient-map} visualises the quotient map and this shows that the quotient map is (by definition of the quotient) surjective.
